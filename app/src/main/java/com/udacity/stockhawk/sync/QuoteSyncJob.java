            ...
            while (iterator.hasNext()) {
                try {
                            ...
                            public void run() {
                                ...
                                Toast.makeText(context,
                                        String.format(context.getResources()
                                                .getString(R.string.error_stock_not_found),symbol.toUpperCase()), Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                    ...
                    for (int i = history.size() - 1; i >= 0; i--) {
                        HistoricalQuote it = history.get(i);
                        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("MMM-yyyy");
                        historyBuilder.append(simpleDateFormat.format(it.getDate().getTimeInMillis()));
